...
// End Cross Module References
	DEFINE_FUNCTION(AItem::execTransformedCosin)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=P_THIS->TransformedCosin();
		P_NATIVE_END;
	}
	...
	void AItem::StaticRegisterNativesAItem()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "TransformedCosin", &AItem::execTransformedCosin },
			{ "TransformedSin", &AItem::execTransformedSin },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AItem_TransformedCosin_Statics
	{
		struct Item_eventTransformedCosin_Parms
		{
			float ReturnValue;
		};
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AItem_TransformedCosin_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Item_eventTransformedCosin_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AItem_TransformedCosin_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AItem_TransformedCosin_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AItem_TransformedCosin_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/Item.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AItem_TransformedCosin_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AItem, nullptr, "TransformedCosin", nullptr, nullptr, Z_Construct_UFunction_AItem_TransformedCosin_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AItem_TransformedCosin_Statics::PropPointers), sizeof(Z_Construct_UFunction_AItem_TransformedCosin_Statics::Item_eventTransformedCosin_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AItem_TransformedCosin_Statics::Function_MetaDataParams), Z_Construct_UFunction_AItem_TransformedCosin_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AItem_TransformedCosin_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AItem_TransformedCosin_Statics::Item_eventTransformedCosin_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AItem_TransformedCosin()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AItem_TransformedCosin_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AItem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AItem_TransformedCosin, "TransformedCosin" }, // 3931903265
		{ &Z_Construct_UFunction_AItem_TransformedSin, "TransformedSin" }, // 4055060820
	};
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_ItemMesh_MetaData[] = {
		...
		{ "Comment", "//adding UPROPERTY allows are var to participate in the reflection system so that are pointer points to a given object\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Items/Item.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "adding UPROPERTY allows are var to participate in the reflection system so that are pointer points to a given object" },
#endif
	};
#endif
	...
	AItem::~AItem() {}
	struct Z_CompiledInDeferFile_FID_UnrealGit_Dungeon_RPG_MyProject_Source_MyProject_Public_Items_Item_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealGit_Dungeon_RPG_MyProject_Source_MyProject_Public_Items_Item_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AItem, AItem::StaticClass, TEXT("AItem"), &Z_Registration_Info_UClass_AItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AItem), 2579740838U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealGit_Dungeon_RPG_MyProject_Source_MyProject_Public_Items_Item_h_3432863976(TEXT("/Script/MyProject"),
		Z_CompiledInDeferFile_FID_UnrealGit_Dungeon_RPG_MyProject_Source_MyProject_Public_Items_Item_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealGit_Dungeon_RPG_MyProject_Source_MyProject_Public_Items_Item_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
